...
export function HomePage({ onNavigate, onLogout, user }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 py-8 min-h-[calc(100vh-80px)]">
        ...
        {/* Sections Grid */}
        <div className={`grid grid-cols-1 ${userType === 'student' ? 'md:grid-cols-2' : 'md:grid-cols-3'} gap-6 max-w-4xl w-full`}>
          {sections.map((section) => (
            ...
            >
              ...
              <div className="absolute top-0 right-0 w-24 h-24 rounded-full opacity-20" style={{ backgroundColor: '#fad656', transform: 'translate(30%, -30%)' }}></div>
              <div className="absolute bottom-0 left-0 w-20 h-20 rounded-full opacity-20" style={{ backgroundColor: '#fad656', transform: 'translate(-30%, 30%)' }}></div>
              ...
              <div className="relative flex flex-col items-center text-center gap-3">
                ...
                >
                  <section.icon className="w-8 h-8 md:w-10 md:h-10" style={{ color: '#652b82' }} />
                </div>
