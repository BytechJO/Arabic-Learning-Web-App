      ...
      <div className="absolute top-0 left-0 right-0 z-30 px-6 py-4 border-b-4" style={{ borderColor: '#652b82', backgroundColor: '#ffffff' }}>
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 px-6 py-3 rounded-2xl shadow-lg" style={{ backgroundColor: mistakes >= 3 ? '#ef4444' : '#ffffff' }}>
              <span className="text-xl" style={{ color: mistakes >= 3 ? '#ffffff' : '#ef4444' }}>
                أخطاء: {mistakes}/3
              </span>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto h-full relative">
          ...
          >
            <p className="text-xl" style={{ color: '#652b82' }}>
              اصطد الكلمات التي تبدأ بحرف الألف فقط!
            </p>
          </motion.div>
        </div>
      </div>
