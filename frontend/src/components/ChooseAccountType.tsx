  ...
  return (
    <div className="min-h-screen relative overflow-hidden" dir="rtl">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4 md:p-6">
        ...
        >
          <h1 className="text-5xl md:text-6xl lg:text-7xl mb-3" style={{ color: '#652b82' }}>
            مرآتي لغتي
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-6 max-w-4xl w-full">
          ...
          >
            ...
            >
              <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-xl border-2 md:border-4 hover:shadow-2xl transition-all min-h-[280px] md:min-h-[320px] flex flex-col items-center justify-center relative overflow-hidden" style={{ borderColor: '#652b82' }}>
                {/* زخرفة خلفية */}
                <div className="absolute top-0 right-0 w-24 h-24 md:w-32 md:h-32 rounded-full opacity-20" style={{ backgroundColor: '#fad656', transform: 'translate(30%, -30%)' }}></div>
                <div className="absolute bottom-0 left-0 w-20 h-20 md:w-24 md:h-24 rounded-full opacity-20" style={{ backgroundColor: '#fad656', transform: 'translate(-30%, 30%)' }}></div>
                ...
                >
                  <div 
                    ...
                    style={{ backgroundColor: '#fad656' }}
                  >
                    <BookOpen className="w-12 h-12 md:w-14 md:h-14" style={{ color: '#652b82' }} />
                  </div>
                </motion.div>

                <h2 className="text-3xl md:text-4xl mb-1" style={{ color: '#652b82' }}>
                  طالب
                </h2>
                ...
                >
                  <ArrowLeft className="w-6 h-6 md:w-7 md:h-7" style={{ color: '#652b82' }} />
                </motion.div>
              </div>
            </button>
          </motion.div>
              ...
              <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-xl border-2 md:border-4 hover:shadow-2xl transition-all min-h-[280px] md:min-h-[320px] flex flex-col items-center justify-center relative overflow-hidden" style={{ borderColor: '#652b82' }}>
                ...
                >
                  <div 
                    ...
                    style={{ backgroundColor: '#fad656' }}
                  >
                    <Users className="w-12 h-12 md:w-14 md:h-14" style={{ color: '#652b82' }} />
                  </div>
                </motion.div>
