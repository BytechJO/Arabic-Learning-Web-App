...
export function LearnLetters({ currentLetter: propLetter, letterName, onBack, onBackToLetters, onActivityChange, user, onLogout }: LearnLettersProps) {
  ...
  useEffect(() => {
    // التحقق من أن الـ API لم يتم تحميله مسبقاً
    if (!window.YT) {
  ...
  const currentLetter = letters.find(l => l.arabic === propLetter) || letters[0];
    ...
    <div className="h-screen relative overflow-hidden pb-24" dir="rtl">
      ...
      {currentSlide === 0 && (
        <div className="relative z-10 h-screen flex flex-col">
          ...
          <div className="flex-1 flex flex-col px-6 pt-4 pb-32">
            ...
            >
              <h1 className="text-2xl md:text-3xl mb-1" style={{ color: '#652b82' }}>
                مرحباً بك في درس حرف {letterName || 'الألف'}
              </h1>
            ...
            >
              <div className="relative bg-white rounded-3xl overflow-hidden shadow-2xl border-4" style={{ borderColor: '#fad656' }}>
                {/* الفيديو */}
                <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                  <iframe
                    id="youtube-player"
                    className="absolute top-0 left-0 w-full h-full"
                    src="https://www.youtube.com/embed/stJeoh3ty1E?enablejsapi=1"
          ...
          <div className="flex-1 flex flex-col px-6 py-4">
            <div className="max-w-5xl w-full mx-auto flex flex-col h-full">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
              >
                <h1 className="text-3xl md:text-4xl mb-1" style={{ color: '#652b82' }}>
              ...
              >
                <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center w-full">
                  ...
                  <div className="text-center">
                    {currentLetter.arabic === 'أ' && currentLetter.image ? (
                      ...
                      <motion.div 
                        ...
                        transition={{ type: "spring", stiffness: 300 }}
                      >
                        <span className="text-7xl md:text-8xl" style={{ color: '#652b82' }}>{currentLetter.arabic}</span>
                      </motion.div>
                    )}
                    
                    <h2 className="text-2xl md:text-3xl" style={{ color: '#652b82' }}>
                      {currentLetter.arabic === 'أ' && currentLetter.image ? (
                        <span>حرف الألف</span>
                      ) : (
                  ...
                  {/* الأمثلة */}
                  <div>
                    {currentLetter.arabic === 'أ' && currentLetter.extraImages ? (
                      ...
                      <>
                        <div className="text-7xl md:text-8xl mb-4 text-center">{currentLetter.emoji}</div>
                        
                        <h3 className="text-3xl md:text-4xl mb-3 text-center" style={{ color: '#652b82' }}>
                          {currentLetter.example}
                        </h3>
                        <p className="text-gray-600 mb-4 text-lg text-center">مثال على الحرف</p>
                        ...
                        <motion.button
                          ...
                          style={{ borderColor: '#652b82', color: '#652b82', backgroundColor: 'white' }}
                          whileHover={{ scale: 1.08, y: -3 }}
                          whileTap={{ scale: 0.95 }}
                          onMouseEnter={(e) => {
                            e.currentTarget.style.background = 'linear-gradient(135deg, #fad656, #f5c842)';
              ...
              >
                <div className="bg-white rounded-3xl p-4 shadow-xl border-4" style={{ borderColor: '#fad656' }}>
      ...
      {onActivityChange && (
        <ActivityFooter 
          ...
          onHomeClick={onBackToLetters || onBack}
